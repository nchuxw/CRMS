		...
		<div class="row">
			...
			<div class="container">
				<div class="col-sm-9 col-sm-offset-3 col-md-4 col-md-offset-2 main">
					<form class="form" method="post" action="ClassAddDoServlet">
						<div class="form-group">
							<label class="form-label">班级：</label> <input class="form-control"
						...
						<div class="form-group">
							<label class="form-label">最低上机学时：</label> <input
								class="form-control" type="text" v-model="currentData.loanRate" maxlength="7"
								onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" name="minPeriod" value="" />
						</div>
