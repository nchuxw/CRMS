	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">按班级统计</h1>
				<form method="post" action="CountOnSituationByClassServlet"
					class="form-inline">
					...
					<div class="form-group">
						<label class="form-label">班级：</label><input class="form-control"
							type="text" name="cla" value='<c:out value="${cla}"></c:out>'>
					</div>
