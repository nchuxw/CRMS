			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<form id="frm" action="RoomEditDoServlet" method="post"
					...
					<table>
						<thead>
							<tr>
								<td><label class="form-label"><font
										style="color: red;">*</font>机房名称：</label> <input class="form-control"
									type="text" name="name" value="${room.name }" /></td>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;<input class="btn btn-primary"
									type="submit" onclick="submitt()" value="保存" /></td>
							</tr>
							<tr>
								<td><label class="form-label">配置：</label><input
									class="form-control" name="config" type="text"
									value="${room.config }" /></td>
							</tr>
							<tr>
								<td>
							<tr>
								<td><label class="form-label">安装软件：</label><input
									class="form-control" name="software" type="text"
									value="${room.software }" /></td>
							</tr>
							<tr>
								<td><label class="form-label">负责人：</label><input
									class="form-control" name="liabler" type="text"
									value="${room.liabler }" /> <br />
							<tr>
								<td><label class="form-label">机房大小：</label> <input
									id="width" type="number" name="width" min="1" max="200"
									value="${room.width }" />*<input id="height" type="number"
									name="height" min="1" max="200" value="${room.height }" /></td>
							</tr>
						</thead>
					</table>
					<table id="edit_com">
						<tr height="50">
							<td width="50"><img id="com" src="images/computer_usable.png"
								draggable="true" ondragstart="drag(event)" width="40"
								height="40" /></td>
							<td id="delet_block" width="50" ondrop="delet_com(event)"
								ondragover="allowDrop(event)"><font color="#99999"
								style="font-size: 12px;">拖到此处删除电脑</font></td>
						</tr>
					</table>
					...
					<input name="room_id" type="hidden" value="${room.roomId }">
