...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-4 col-sm-offset-3 col-md-6 col-md-offset-2 main">
				<h1 class="page-header">设置机房不可用时间段</h1>
				<form action="RoomTimeManageServlet" method="post">
					<div class="form-group">
						<label class="form-label">机房编号：</label> <input
							class="form-control" type="text" name="room_no" value="" />
					</div>
					<div class="form-group">
						<label class="form-label">设置不可用时间段：</label> <input
							class="form-control" type="text" name="unuse_time" value="" />
					</div>
