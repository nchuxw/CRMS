	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-4 col-sm-offset-3 col-md-6 col-md-offset-2 main">
				<h1 class="page-header">设置班级上机最低学时</h1>
				<form action="SetMinScoreServlet" method="post">
					<div class="form-group">
						<label class="form-label">输入班级：</label> <input
							class="form-control" type="text" name="cla" value="" />
					</div>
					<div class="form-group">
						<label class="form-label">设置最低学时：</label> <input
							class="form-control" type="text" name="min_score" value="" />
					</div>
