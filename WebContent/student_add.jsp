		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-4 col-md-offset-2 main">
				<form class="form" method="post"
					...
					<div class="form-group">
						<label class="form-label">密码：</label> <input class="form-control"
							type="text" maxlength="16" name="password" value="" />
					</div>
					<div class="form-group">
						<label class="form-label">类型：</label> <select class="form-control" name="type">
							<option value="">请选择</option>
							<option value="student" >student</option>
							<option value="comrmer" >comrmer</option>
						</select>
					</div>
					<input class="form-control"
							type="hidden" name="classId" value='${param.id}' />
