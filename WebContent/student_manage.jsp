	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="row">
					<div class="col-sm-9">
						<form name="frm" class="form-inline" action="StudentManageServlet?id=${classid}"
							method="post">
							<div class="form-group">
								...
								onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" value='<c:out value="${userNo}"></c:out>'>
							</div>
							<div class="form-group">
								<label class="form-label">姓名：</label><input class="form-control"
									type="text" name="name" value='<c:out value="${name}"></c:out>'>
							</div>
					...
					<div class="btn-group col-sm-3">
						<button type="button" class="btn btn-info dropdown-toggle"
							data-toggle="dropdown" onclick='window.location="student_add.jsp?id=${classid}"' aria-haspopup="true" aria-expanded="false">
							添加学生 
						</button>
				...
				<div class="table-responsive">
					<form onSubmit="checkForm()" action="StudentsDeleteServlet?id=${classid}">
					<p>&nbsp;</p>
						...
						<table class="table table-striped">
							...
							<tbody>
								<c:forEach items="${list }" var="user">
									<tr>
										<td><input type="checkbox" onclick="" name="ck" value='<c:out value="${user.userId}"></c:out>'></td>
										...
										<td><a class="btn btn-primary"
											href='StudentEditServlet?id=${user.userId}'>修改</a> <a
											class="btn btn-danger"
											href='StudentDeleteServlet?id=${user.userId}&classId=${user.classId}'>删除</a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
